...
public final class BrandConstants {
    ...
    public static final int FIELD_NAME_MIN_SIZE = 3;
    ...
    public static final int FIELD_DESCRIPTION_MAX_SIZE = 120;

    public static final String FIELD_DESCRIPTION_SIZE_MESSAGE = "Field 'description' must be between" + FIELD_DESCRIPTION_MIN_SIZE + "and " + FIELD_DESCRIPTION_MAX_SIZE +"characters";
}
